...
<!-- All items are required. If not applicable, explain why. -->
...
<!-- What assumptions does the PM hold that are no longer true? Write for non-engineers. If nothing changed from PM perspective, say "No PM-visible changes." -->

## Rollout Plan

**Risk level:** <!-- Low / Medium / High / Critical -->
**Strategy:** <!-- Direct deploy / Feature flag + soak / Canary X% / Manual gates -->
**Go/no-go criteria:** <!-- specific metrics and thresholds -->

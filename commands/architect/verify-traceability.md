...
4. **Cross-slice composition** — if this change spans multiple decision-packet slices, verify the slices compose correctly end-to-end (no interface mismatches between them).

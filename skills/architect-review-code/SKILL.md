...
**Refusal rule:** If `.hitl/current-change.yaml` does not show both `code_review.round_1: complete` and `code_review.round_2: complete`, stop: "AI review rounds 1 and 2 must complete before architect review. Run `/hitl:dev-review-lld-adherence` for Round 1, then Round 2."

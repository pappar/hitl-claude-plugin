...
2. **Generate the ADR** following the template at `${CLAUDE_PLUGIN_ROOT}/shared/templates/adr-template.md`:
...
Generate a GitHub issue using the issue template (`${CLAUDE_PLUGIN_ROOT}/shared/templates/issue-template.md`):
